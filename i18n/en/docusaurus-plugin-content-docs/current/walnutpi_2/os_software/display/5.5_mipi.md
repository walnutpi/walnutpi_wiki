...
核桃派官方推出的5.5寸MIPI屏分辨率为1080P（1920x1080）。[购买连接>>](https://www.aliexpress.com/item/1005010811805435.html)
...
核桃派2B拥有1路MIPI DSI接口（1x4 lane DSI，兼容2 lane）。可外接MIPI显示屏，最大支持1080P@60fps。接口定义兼容树莓派。
